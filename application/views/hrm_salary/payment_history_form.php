    ...
    <div class="sixteen wide column">
        ...
        <div class="ui segments">
            <div class="ui segment">
                <h3 class="ui header">Payment History</h3>
            </div>
            <div class="ui segment">
                <?php echo form_open_multipart('Hrm_salary/view_records',array("class"=>"ui form")); ?>
                <div class="ui form">
                    ...
                    <button type="submit" class="ui primary button">View Records</button>
