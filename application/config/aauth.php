...
| -------------------------------------------------------------------
|
|   ['no_permission']                   If hrm_user don't have permisssion to see the page he will be redirected the page spesificed.
|
|   ['admin_group']                     Name of admin group
|   ['default_group']                   Name of default group, the new hrm_user is added in it
...
|
|   ['ddos_protection']                 Enables the DDoS Protection, hrm_user will be banned temporary when he exceed the login 'try'
|
